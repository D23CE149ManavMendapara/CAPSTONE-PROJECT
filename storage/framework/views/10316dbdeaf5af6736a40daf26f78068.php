              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    ...
                    <a data-fancybox="gallery" href="<?php echo e(asset('uploads/products')); ?>/<?php echo e($product->image); ?>" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="<?php echo e(route('shop.product.details',['product_slug'=>$rproduct->slug])); ?>">
                  ...
                  <?php $__currentLoopData = explode(",",$product->images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <img loading="lazy" src="a<?php echo e(asset('uploads/products')); ?>/<?php echo e($gimg); ?>" width="330" height="400" alt="<?php echo e($rproduct->name); ?>" class="pc__img pc__img-second">
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </a>
              ...
              <input type="hidden" name="price" value="<?php echo e($rproduct->sale_price == '' ? $rproduct->regular_price : $rproduct->sale_price); ?>" />
                <button type="submit"
                  class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer" title="Add To Cart">Add To Cart</button>
                </form>
                  <?php endif; ?>
              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel11ecommerce\resources\views/details.blade.php ENDPATH**/ ?>