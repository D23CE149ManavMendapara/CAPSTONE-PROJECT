                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pname">
                                                            <div class="image">
                                                                <img src="<?php echo e(asset('uploads/categories')); ?>/<?php echo e($category->image); ?>" alt="<?php echo e($category->name); ?>" class="image">
                                                            </div>
                                                            <div class="name">
                                                            ...
                                                            <div class="list-icon-function">
                                                                ...
                                                                <form action="<?php echo e(route('admin.category.delete',['id'=>$category->id])); ?>" method="POST">
                                                                    ...
                                                                    <div class="item text-danger delete">
                                                                        <button class="icon-trash-2"></button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel11ecommerce\resources\views/admin/categories.blade.php ENDPATH**/ ?>